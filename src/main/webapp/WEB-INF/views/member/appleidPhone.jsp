...
<body>
	...
	<div style="margin-left: 20%; margin-top: 100px;">
		<ul style="display: flex;">
			<li>
				<form method="post" action="/member/checkPhone">
					<h2>전화번호를 확인하십시오.</h2>
					<div style="margin-top: 50px;">Apple ID에 사용하는 전화번호를 입력하십시오.</div>
					<input type="hidden" name="id" value="${member.id}">
					<input type="text" name="phone" id="ApplePhoneInput" placeholder="전화번호" ><br><br>
