...
<body>
	...
	<div>
		<div>주문 번호 : ${list[0].nonMemberOrder_id}</div>
		<div>주문 일시:${list[0].nm_order_date}</div>
		<hr>
	</div>
	<div>
		<h2>주문 세부 정보</h2>
		...
		<hr>
			...
			<form action="finish" method="post" id="fin">
				<div class="form-group" id="divName">
			     ...
			     <div class="col-lg-10">
			         <input type="text" name="rname" class="form-control onlyHangul" id="name" data-rule-required="true" value="${list[0].nm_name}" maxlength="15" readonly>
			     </div>
			 	</div>
				...
				<div class="form-group" id="divEmail">
			     ...
			     <div class="col-lg-10">
			         <input type="text" name="raddr" class="form-control" id="address" data-rule-required="true" value="${list[0].nm_email}" maxlength="40" readonly>
			     </div>
				</div>
				...
				<div class="form-group" id="divEmail">
			     ...
			     <div class="col-lg-10">
			         <input type="email" name="remail" class="form-control" id="email" data-rule-required="true" value="${list[0].nm_address}" maxlength="40" readonly>
			     </div>
				</div>
				<div class="form-group" id="divPhoneNumber">
			     <label for="inputPhoneNumber" class="col-lg-2 control-label">전화번호</label>
			     <div class="col-lg-10">
			         <input type="tel" name="rphone" class="form-control onlyNumber" id="phoneNumber" data-rule-required="true" value="${list[0].nm_phone}" maxlength="11" readonly>
			     </div>
				</div>
			</form>
		</div>
		...
		<div style="margin-top: 2%;">
			...
			<div class="form-group" id="divName">
		     <label for="inputName" class="col-lg-2 control-label">이름</label>
		     <div class="col-lg-10">
		         <input type="text" name="name" class="form-control onlyHangul" id="name" data-rule-required="true" value="${list[0].nm_name}" maxlength="15" readonly>
		     </div>
		 	</div>
			...
			<div class="form-group" id="divEmail">
		     <label for="inputEmail" class="col-lg-2 control-label">주소</label>
		     <div class="col-lg-10">
		         <input type="text" name="address" class="form-control" id="address" data-rule-required="true" value="${list[0].nm_address}" maxlength="40" readonly>
		     </div>
			</div>
		</div>
		<hr>
