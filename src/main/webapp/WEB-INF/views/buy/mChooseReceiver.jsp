...
<body>
	...
	<div>
		...
		<div style="margin-top: 2%;">
			...
			<form action="mPay" method="post" id="pay">
				<div class="form-group" id="divName">
			     <label for="inputName" class="col-lg-2 control-label">이름</label>
			     <div class="col-lg-10">
			         <input type="text" name="rname" class="form-control onlyHangul" id="name" data-rule-required="true" value="${member.name}" maxlength="15" >
			     </div>
			 	</div>
				...
				<div class="form-group" id="divEmail">
			     ...
			     <div class="col-lg-10">
			         <input type="text" name="raddr" class="form-control" id="address" data-rule-required="true" value="${member.address}" maxlength="40" >
			     </div>
				</div>
				...
				<div class="form-group" id="divEmail">
			     ...
			     <div class="col-lg-10">
			         <input type="email" name="remail" class="form-control" id="email" data-rule-required="true" value="${member.email}" maxlength="40" >
			     </div>
				</div>
				<div class="form-group" id="divPhoneNumber">
			     <label for="inputPhoneNumber" class="col-lg-2 control-label">전화번호</label>
			     <div class="col-lg-10">
			         <input type="tel" name="rphone" class="form-control onlyNumber" id="phoneNumber" data-rule-required="true" value="${member.phone}" maxlength="11" >
			     </div>
				</div>
			</form>
		</div>
		...
		<hr>
		<input type="submit"  value="결제" onclick="pay()">
	</div>
