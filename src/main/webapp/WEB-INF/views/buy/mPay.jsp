...
<body>
	...
	<div>
		...
		<div style="margin-top: 2%;">
			<h2>배송 상세정보</h2>
			<div>배송지 정보를 확인해 주세요</div>
			<div style="margin-bottom: 1%; margin-top: 1%;">배송지:</div>
			<form action="finish" method="post" id="fin">
				<div class="form-group" id="divName">
			     <label for="inputName" class="col-lg-2 control-label">이름</label>
			     <div class="col-lg-10">
			         <input type="text" name="rname" class="form-control onlyHangul" id="name" data-rule-required="true" value="${receiver.rname}" maxlength="15" readonly>
			     </div>
			 	</div>
				...
				<div class="form-group" id="divEmail">
			     ...
			     <div class="col-lg-10">
			         <input type="text" name="raddr" class="form-control" id="address" data-rule-required="true" value="${receiver.raddr}" maxlength="40" readonly>
			     </div>
				</div>
				...
				<div class="form-group" id="divEmail">
			     ...
			     <div class="col-lg-10">
			         <input type="email" name="remail" class="form-control" id="email" data-rule-required="true" value="${receiver.remail}" maxlength="40" readonly>
			     </div>
				</div>
				<div class="form-group" id="divPhoneNumber">
			     <label for="inputPhoneNumber" class="col-lg-2 control-label">전화번호</label>
			     <div class="col-lg-10">
			         <input type="tel" name="rphone" class="form-control onlyNumber" id="phoneNumber" data-rule-required="true" value="${receiver.rphone}" maxlength="11" readonly>
			     </div>
				</div>
			</form>
		</div>
		...
		<div style="margin-top: 2%;">
			<h2>총계</h2>
			<div>총 결제액: ${totalPrice}</div>
		</div>
		<hr>
		<input type="submit" value="KG 이니시스로 계속 진행" onclick="finish()">
	</div>
